...
class QualitativeAnalysisFrame3(Frame):
	...
	def serial_handle(self):
		...
		if(bled_ready):
			...
			img.anchor = 'J19'
			sheet.add_image(img)
			sheet["C18"] = self.base_window.qualitative_analysis_0.template_name
			...
			sheet["B68"] = "Kết quả thử nghiệm chỉ có giá trị trên mẫu thử"
			
			sheet['B69'] = 'Note:'
			sheet["B69"].font = font2
			sheet['B70'] = '+ N/A: No sample'
			sheet['B71'] = '+ N: Negative'
			sheet['C70'] = '+ P_L: Low copy'
			sheet['C71'] = '+ P_H: Positive'
			...
			for i in range (20,68):
				if(i<28):
					sheet['C'+str(i)] = str(chr(65+i-20)) + '1'
				elif(i<36):
					sheet['C'+str(i)] = str(chr(65+i-28)) + '2'
				elif(i<44):
					sheet['C'+str(i)] = str(chr(65+i-36)) + '3'
				elif(i<52):
					sheet['C'+str(i)] = str(chr(65+i-44)) + '4'
				elif(i<60):
					sheet['C'+str(i)] = str(chr(65+i-52)) + '5'
				else:
					sheet['C'+str(i)] = str(chr(65+i-60)) + '6'
			...
			if(self.base_window.main_menu.threshold_value == 0):
				for i in range(0,8):
					c1=c1+6
					sheet['B'+str(i+20)] = self.base_window.qualitative_analysis_2.id_list[c1]
					if(self.base_window.qualitative_analysis_2.id_list[c1]=='N/A'):
						sheet['F'+str(i+20)] = 'N/A'
					else:
						if(float(self.result_label[c1]['text']) <= self.base_window.main_menu.num1):
							sheet['F'+str(i+20)] = 'N'
							sheet['F'+str(i+20)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
						elif(float(self.result_label[c1]['text']) <= self.base_window.main_menu.num3):
								sheet['F'+str(i+20)] = 'P_L'
								sheet['F'+str(i+20)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
								sheet['F'+str(i+20)].font = font2
								sheet['F'+str(i+20)].font = font2
						else:
							sheet['F'+str(i+20)] = 'P_H'
							sheet['F'+str(i+20)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
							sheet['F'+str(i+20)].font = font2
					...
					c2=c2+6
					sheet['B'+str(i+28)] = self.base_window.qualitative_analysis_2.id_list[c2]
					if(self.base_window.qualitative_analysis_2.id_list[c2]=='N/A'):
						sheet['F'+str(i+28)] = 'N/A'
					else:
						if(float(self.result_label[c2]['text']) <= self.base_window.main_menu.num1):
							sheet['F'+str(i+28)] = 'N'
							sheet['F'+str(i+28)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
						elif(float(self.result_label[c2]['text']) <= self.base_window.main_menu.num3):
							sheet['F'+str(i+28)] = 'P_L'
							sheet['F'+str(i+28)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
							sheet['F'+str(i+28)].font = font2
							sheet['B'+str(i+28)].font = font2
						else:
							sheet['F'+str(i+28)] = 'P_H'
							sheet['F'+str(i+28)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
							sheet['F'+str(i+28)].font = font2
							sheet['B'+str(i+28)].font = font2
					...
					c3=c3+6
					sheet['B'+str(i+36)] = self.base_window.qualitative_analysis_2.id_list[c3]
					if(self.base_window.qualitative_analysis_2.id_list[c3]=='N/A'):
						sheet['F'+str(i+36)] = 'N/A'
					else:
						if(float(self.result_label[c3]['text']) <= self.base_window.main_menu.num1):
							sheet['F'+str(i+36)] = 'N'
							sheet['F'+str(i+36)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
						elif(float(self.result_label[c3]['text']) <= self.base_window.main_menu.num3):
							sheet['F'+str(i+36)] = 'P_L'
							sheet['F'+str(i+36)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
							sheet['F'+str(i+36)].font = font2
							sheet['B'+str(i+36)].font = font2
						else:
							sheet['F'+str(i+36)] = 'P_H'
							sheet['F'+str(i+36)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
							sheet['F'+str(i+36)].font = font2
							sheet['B'+str(i+36)].font = font2
					...
					c4=c4+6
					sheet['B'+str(i+44)] = self.base_window.qualitative_analysis_2.id_list[c4]
					if(self.base_window.qualitative_analysis_2.id_list[c4]=='N/A'):
						sheet['F'+str(i+44)] = 'N/A'
					else:
						if(float(self.result_label[c4]['text']) <= self.base_window.main_menu.num1):
							sheet['F'+str(i+44)] = 'N'
							sheet['F'+str(i+44)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
						elif(float(self.result_label[c4]['text']) <= self.base_window.main_menu.num3):
							sheet['F'+str(i+44)] = 'P_L'
							sheet['F'+str(i+44)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
							sheet['F'+str(i+44)].font = font2
							sheet['B'+str(i+44)].font = font2
						else:
							sheet['F'+str(i+44)] = 'P_H'
							sheet['F'+str(i+44)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
							sheet['F'+str(i+44)].font = font2
							sheet['B'+str(i+44)].font = font2
					...
					c5=c5+6
					sheet['B'+str(i+52)] = self.base_window.qualitative_analysis_2.id_list[c5]
					if(self.base_window.qualitative_analysis_2.id_list[c5]=='N/A'):
						sheet['F'+str(i+52)] = 'N/A'
					else:
						if(float(self.result_label[c5]['text']) <= self.base_window.main_menu.num1):
							sheet['F'+str(i+52)] = 'N'
							sheet['F'+str(i+52)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
						elif(float(self.result_label[c5]['text']) <= self.base_window.main_menu.num3):
							sheet['F'+str(i+52)] = 'P_L'
							sheet['F'+str(i+52)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
							sheet['F'+str(i+52)].font = font2
							sheet['B'+str(i+52)].font = font2
						else:
							sheet['F'+str(i+52)] = 'P_H'
							sheet['F'+str(i+52)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
							sheet['F'+str(i+52)].font = font2
							sheet['B'+str(i+52)].font = font2
					...
					c6=c6+6
					sheet['B'+str(i+60)] = self.base_window.qualitative_analysis_2.id_list[c6]
					if(self.base_window.qualitative_analysis_2.id_list[c6]=='N/A'):
						sheet['F'+str(i+60)] = 'N/A'
					else:
						if(self.result_label[c6]['text'] != 'B'):
							if(float(self.result_label[c6]['text']) <= self.base_window.main_menu.num1):
								sheet['F'+str(i+60)] = 'N'
								sheet['F'+str(i+60)].fill = PatternFill(start_color='0000FF00', end_color='0000FF00', fill_type='solid')
							elif(float(self.result_label[c6]['text']) <= self.base_window.main_menu.num3):
								sheet['F'+str(i+60)] = 'P_L'
								sheet['F'+str(i+60)].fill = PatternFill(start_color='00FFCCFF', end_color='00FFCCFF', fill_type='solid')
								sheet['F'+str(i+60)].font = font2
								sheet['B'+str(i+60)].font = font2
							else:
								sheet['F'+str(i+60)] = 'P_H'
								sheet['F'+str(i+60)].fill = PatternFill(start_color='00FF9999', end_color='00FF9999', fill_type='solid')
								sheet['F'+str(i+60)].font = font2
								sheet['B'+str(i+60)].font = font2
				...
				for i in range(0,8):
					...
					# ~ sheet['F'+str(i+52)].protection = Protection(locked=False, hidden=False)
			first_result_row = 20
			last_result_row = first_result_row + 48*2
			row = first_result_row
			tmp_row_value = first_result_row
			for i in range(first_result_row,last_result_row):
			...
			sheet.merge_cells(start_row=tmp_row_value + 6, start_column=5, end_row=tmp_row_value + 6, end_column=7)
			sheet.merge_cells(start_row=tmp_row_value + 7, start_column=5, end_row=tmp_row_value + 7, end_column=7)
			sheet['B'+str(tmp_row_value + 6)] = 'KỸ THUẬT VIÊN'
			sheet['B'+str(tmp_row_value + 7)] = ''
			sheet['E'+str(tmp_row_value + 6)] = 'TRƯỞNG PHÒNG XÉT NGHIỆM'
			sheet['E'+str(tmp_row_value + 7)] = ''
			sheet["B"+str(tmp_row_value + 6)].font = font2
			sheet["E"+str(tmp_row_value + 6)].font = font2
			# ~ sheet["B73"].protection = Protection(locked=False, hidden=False)
			# ~ sheet["D73"].protection = Protection(locked=False, hidden=False)
			sheet.cell(row=tmp_row_value + 6,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
			sheet.cell(row=tmp_row_value + 7,column=2).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
			sheet.cell(row=tmp_row_value + 6,column=5).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
			sheet.cell(row=tmp_row_value + 7,column=5).alignment = Alignment(horizontal='center',vertical='center',wrapText=True)
